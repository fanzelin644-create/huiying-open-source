  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      ...
      <main className="w-full max-w-6xl mx-auto px-6 pt-10 pb-12">
        ...
        {loading ? (
          <div className="h-56 rounded-2xl border border-gray-200 bg-surface flex items-center justify-center text-sm text-gray-400">
          ...
          <div className="space-y-5">
            {groups.map(group => (
              <section key={group.title} className="rounded-2xl border border-gray-200 bg-surface p-5 shadow-sm">
                <div className="mb-4">
                      ...
                      <label key={field.path} className="flex flex-col gap-1.5 min-w-0">
                        ...
                        {field.type === 'boolean' ? (
                          ...
                          <input
                            ...
                            placeholder="输入新密钥覆盖"
                            className="h-10 rounded-lg border border-gray-200 bg-surface px-3 font-mono text-sm text-gray-700 outline-none focus:border-blue-300"
                          />
                        ) : (
                          <input
            ...
            <div className="sticky bottom-4 flex items-center gap-3 rounded-2xl border border-gray-200 bg-surface/95 p-3 shadow-lg backdrop-blur">
              {message && (
