  ...
  return (
    <label className="flex flex-col gap-1.5 min-w-0">
      ...
      <select
        ...
        className="h-10 rounded-lg border border-gray-200 bg-surface px-3 text-sm text-gray-700 outline-none focus:border-blue-300"
      >
        {groups.map(group => (
    ...
    <label className="flex flex-col gap-1.5 min-w-0">
      ...
      <div className="flex gap-2">
        <input
          ...
          placeholder={placeholder}
          className="h-10 min-w-0 flex-1 rounded-lg border border-gray-200 bg-surface px-3 text-sm text-gray-700 outline-none focus:border-blue-300"
        />
          ...
          <button
            ...
            className={clsx(
              ...
              uploading
                ...
                : 'border-gray-200 bg-surface text-gray-500 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-600'
            )}
            title="上传媒体"
          >
        ...
        {value && (
          <button
            ...
            className="h-10 w-10 rounded-lg border border-gray-200 bg-surface text-gray-400 hover:bg-gray-50 hover:text-red-500 flex items-center justify-center flex-shrink-0"
            title="清除"
          >
            <X className="w-4 h-4" />
          </button>
  ...
  return (
    <section className="mb-4 rounded-xl border border-blue-100 bg-blue-50/40 p-3">
      ...
      {item ? (
        ...
        <div className="h-36 rounded-lg border border-dashed border-blue-200 bg-surface/60 flex items-center justify-center text-sm text-gray-400">
          最终视频生成后显示
        </div>
      )}
    </section>
...
function TaskResult({ task }: { task: PipelineTask | null }) {
  ...
  if (!task) {
    return (
      <div className="bg-surface rounded-2xl border border-gray-200 p-5 shadow-sm h-full">
        ...
        <div className="max-h-[28rem] overflow-y-auto pr-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {mediaArtifacts.map((item, index) => (
              ...
              >
                <div className="h-8 px-3 border-b border-gray-200 bg-surface flex items-center gap-2">
...
function TemplatePreviewCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={clsx(
        'group flex-shrink-0 rounded-lg border bg-surface p-1.5 text-left transition-all',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {tasks.map(task => (
          <div
            ...
            className={clsx(
              'group text-left p-4 bg-surface rounded-xl border hover:border-blue-300 hover:shadow-sm transition-all',
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 overflow-y-auto">
      ...
      <div className="w-full max-w-6xl mx-auto px-6 pt-10 pb-8">
        ...
        {pipeline === 'standard' && (
          <section className="mb-5 rounded-2xl border border-gray-200 bg-surface p-4 shadow-sm">
            <div className="flex flex-col gap-3 md:flex-row md:items-center">
              <button
                ...
                className={clsx(
                  ...
                  templateMode
                    ? 'bg-media text-white hover:bg-media'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_minmax(340px,0.9fr)] gap-5 items-start">
          <section className="bg-surface rounded-2xl shadow-sm border border-gray-200 p-5">
            {pipeline === 'standard' && (
              <div className="space-y-4">
                    ...
                    <div className="grid h-10 max-w-sm grid-cols-3 rounded-lg bg-gray-100 p-1 text-sm">
                      {['9:16', '1:1', '16:9'].map(item => (
                        <button
                          ...
                          className={clsx('rounded-md transition-colors', ratio === item ? 'bg-surface text-blue-600 shadow-sm' : 'text-gray-500')}
                        >
                          {item}
                        </button>
                      ))}
                      ...
                      <div className="overflow-x-auto">
                        <div className="flex gap-3 pb-1">
                          {ratioTemplates.length ? (
                            ...
                            <div className="flex h-28 min-w-0 flex-1 items-center justify-center rounded-xl border border-dashed border-gray-200 bg-surface text-xs text-gray-400">
                              当前比例暂无模版
                            </div>
                          )}
                        </div>
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={clsx(
                            ...
                            templateMediaKind === item.id ? 'bg-surface text-blue-600 shadow-sm' : 'text-gray-500',
                  ...
                  <div className="grid grid-cols-2 h-10 rounded-lg bg-gray-100 p-1 text-sm max-w-sm">
                    {[
                      ...
                      <button
                        ...
                        className={clsx('rounded-md transition-colors', standardVideoMode === item.id ? 'bg-surface text-blue-600 shadow-sm' : 'text-gray-500')}
                      >
                        {item.label}
                      </button>
                    ))}
                ...
                <div className="grid grid-cols-2 h-10 rounded-lg bg-gray-100 p-1 text-sm max-w-sm">
                  {[
                    ...
                    <button
                      ...
                      className={clsx('rounded-md transition-colors', standardMode === item.id ? 'bg-surface text-blue-600 shadow-sm' : 'text-gray-500')}
                    >
                      {item.label}
                    </button>
                  ))}
                ...
                <textarea
                  ...
                  className="w-full min-h-[150px] resize-none rounded-xl border border-gray-200 bg-surface px-3 py-3 text-sm text-gray-800 outline-none focus:border-blue-300"
                />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      {selectedTemplateFields.map(field => (
                        <label key={field.key} className="grid grid-cols-[92px_minmax(0,1fr)] items-center gap-2">
                          ...
                          <input
                            ...
                            className="h-9 min-w-0 rounded-lg border border-gray-200 bg-surface px-3 text-sm text-gray-700 outline-none focus:border-blue-300"
                          />
                        </label>
                      ))}
                    </div>
            ...
            {pipeline === 'action_transfer' && (
              <div className="space-y-4">
                <textarea
                  ...
                  className="w-full min-h-[130px] resize-none rounded-xl border border-gray-200 bg-surface px-3 py-3 text-sm text-gray-800 outline-none focus:border-blue-300"
                />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 flex flex-wrap items-center gap-2">
              ...
              {pipeline === 'standard' && (
                <>
                  <label className="flex items-center gap-2 h-9 rounded-lg border border-gray-200 bg-surface px-3 text-xs font-medium text-gray-600">
                    <input
                      type="checkbox"
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-xl space-y-3">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <label className="flex flex-col gap-1.5">
                    ...
                    <select value={ratio} onChange={e => setRatio(e.target.value)} className="h-10 rounded-lg border border-gray-200 bg-surface px-3 text-sm text-gray-700 outline-none">
                  ...
                  <label className="flex flex-col gap-1.5">
                    ...
                    <select value={videoResolution} onChange={e => setVideoResolution(e.target.value)} className="h-10 rounded-lg border border-gray-200 bg-surface px-3 text-sm text-gray-700 outline-none">
                ...
                <label className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[70px] resize-none rounded-lg border border-gray-200 bg-surface px-3 py-2 text-sm text-gray-700 outline-none focus:border-blue-300"
                  />
                </label>
                {pipeline === 'standard' && (
