...
function ClipRow({
  ...
  return (
    <div className={`flex flex-col xl:flex-row border rounded-xl overflow-hidden bg-surface ${disabled ? 'opacity-50' : ''} ${
