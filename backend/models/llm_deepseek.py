...
class DeepSeek:
    ...
    def __init__(self, base_url="", api_key="", timeout=None, max_attempts=None):
        ...
        # Use the application proxy setting, never inherit shell proxy variables.
        kwargs["http_client"] = httpx.Client(proxy=proxy or None, trust_env=False, timeout=self.timeout)
