...
class SeedanceVideoClient:
    ...
    def generate_video(
        ...
        image_path: str,
        save_path: str,
        model: str = "doubao-seedance-2-0-mini-260615",
        duration: int = 5,
        **kwargs
    ) -> str:
        """
    ...
    def _submit_task(self, prompt: str, image_path: str, model: str, duration: int, **kwargs) -> str:
        ...
        paths = kwargs.get("image_paths") or [image_path]
        mode = kwargs.get("reference_mode", "first_frame")
        role = "reference_image" if mode == "reference" or len(paths) > 1 else "first_frame"
